...
auto main(int argc, char **argv) -> int {
  ...
  glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, static_cast<GLsizei>(g_screen_width),
               static_cast<GLsizei>(g_screen_height), 0, GL_RGB, GL_UNSIGNED_BYTE, nullptr);
  ...
  glRenderbufferStorage(
      GL_RENDERBUFFER, GL_DEPTH24_STENCIL8, static_cast<GLsizei>(g_screen_width),
